namespace PFire.Core.Protocol.Messages
{
    public enum XFireMessageType : short
    {
        ...
        GameClientData = 35,
        Logout = 36,
        UserRequestAdvancedInfo = 37,
        ClanRequestAccept = 44,
        ClanRequestDecline = 45,
        LoginChallenge = 128,
        LoginFailure = 129,
        LoginSuccess = 130,
        FriendsList = 131,
        ...
        ClanMemberNameChange = 162,
        ClanNameChanged = 164,
        ClanInvitation = 165,
        ClanPreferences = 166,
        ClanRanks = 167,
        ClanRankPermissions = 168,
        SystemBroadcast = 169,
        ClanEvents = 170,
        ClanEventDeleted = 171,
        FriendScreenshots = 172,
        UserAdvancedInfoChanged = 173,
        UserAvatarInfo = 174,
        ClanFriendClanInfo = 176,
        ClanNewsPostedOnPage = 177,
        ClanAvatarVersion = 178,
        UserVideos = 179,
        FriendVideos = 182,
        ClanFavoriteGameServers = 188,
        ClanGameServerUnknown = 189,
